...
public:
    ...
    /* Metodo para asignar el DPI, nombre, fecha de nacimiento y lugar de origen de una persona (set) */
    ...
    int Asignar_Asignar_Lugar_Origen(std::string Lugar);

    /* Metodo para obtener el DPI, nombre, fecha de nacimiento y lugar de origen de una persona (get) */
