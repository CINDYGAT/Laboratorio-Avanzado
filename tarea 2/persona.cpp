...
/*Metodo para asignar nombre (set method)*/
 ...
 /*Metodo para asignar la fecha de nacimiento (set method)*/
  ...
  /*Metodo para asignar lugar de origen (set method)*/
   int persona::Asignar_Lugar_Origen(std::string Lugar)
   {
     ...
     std::cout << "El lugar de nacimiento ya fue asignado" << std::endl;
     return 1;
   }
...
/* Metodo para obtener el nombre a una persona (get method)
 * devuelve un string con el nombre de la persona */
...
/* Metodo para obtener el anio de nacimiento una persona (get method) */
...
/* Metodo para obtener el mes de nacimiento una persona (get method) */
...
/* Metodo para obtener el dia de nacimiento una persona (get method) */
...
/* Metodo para obtener el nlugar de origen a una persona (get method)
 * devuelve un string con el lugar de origen de la persona */
