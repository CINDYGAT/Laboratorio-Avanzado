...
simple::simple( std::string La_Frase )
{
    ...
    /* Se incrementa el valor del atributo de clase. */
    Numero++;
    /*Igualar ID con Numero para constructores*/
    ID = Numero;
}
...
/*Implementacion del metodo Mostrar_ID para los atributos*/
void simple::Mostrar_ID()
{
    std::cout << "El ID proporcionado es:  " << ID << std::endl;
}
