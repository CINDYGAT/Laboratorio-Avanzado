...
void ReadCVS(const char* FileName, const char* FileName2, unsigned bins, double Range_min, double Range_max, double Range_min1, double Range_max1, double Range_min2, double Range_max2)
{
   ...
   // Dark_Current_Profile->Draw();
    ...
    TF1 *lFunc1 = new TF1("line","[0]+[1]*x",Range_min1,Range_max1);
